    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-grid">
          ...
          <div className="footer-about">
            <div className="footer-logo">
              <Droplet className="footer-logo-icon animated-icon" />
              <span className="footer-logo-text">JalSetu</span>
            </div>
          ...
          <div className="footer-resources">
            ...
            <ul className="footer-link-list">
              ...
              <li>
                <a href="#" className="footer-link hover-slide-animation">
                  <ChevronRight size={14} className="footer-link-icon" /> Events
                </a>
              </li>
              <li>
                <a href="#" className="footer-link hover-slide-animation">
                  <ChevronRight size={14} className="footer-link-icon" /> FAQ
                </a>
              </li>
            </ul>
          </div>
          ...
          <div className="footer-contact">
            ...
            <a href="#" className="contact-button pulse-button">
              Contact Us
            </a>
        ...
        <div className="footer-bottom">
          <div className="copyright">© 2025 JalSetu. All rights reserved.</div>
          <div className="social-links">
            <a href="#" className="social-link social-hover-effect">
              <svg
